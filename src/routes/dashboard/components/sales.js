...
function Sales ({ data }) {
  return (
    <div className={styles.sales}>
      <div className={styles.title}>一周数据统计</div>
      <ResponsiveContainer minHeight={360}>
        <LineChart data={data}>
          ...
          />
          <Line type="monotone" dataKey="转发失败" stroke={color.purple} strokeWidth={3} dot={{ fill: color.purple }} activeDot={{ r: 5, strokeWidth: 0 }} />
          <Line type="monotone" dataKey="转发成功" stroke={color.red} strokeWidth={3} dot={{ fill: color.red }} activeDot={{ r: 5, strokeWidth: 0 }} />
          <Line type="monotone" dataKey="到达" stroke={color.green} strokeWidth={3} dot={{ fill: color.green }} activeDot={{ r: 5, strokeWidth: 0 }} />
          <Line type="monotone" dataKey="打开" stroke={color.yellow} strokeWidth={3} dot={{ fill: color.yellow }} activeDot={{ r: 5, strokeWidth: 0 }} />
          <Line type="monotone" dataKey="过期" stroke={color.orange} strokeWidth={3} dot={{ fill: color.orange }} activeDot={{ r: 5, strokeWidth: 0 }} />
        </LineChart>
      </ResponsiveContainer>
    </div>
  )
