...
const EditorPage = ({ statistic,dispatch }) => {
  const { data,types } = statistic
  const colProps = {
    lg: 12,
    md: 24,
  }
...
export default connect(({ statistic, loading }) => ({ statistic, loading: loading.models.statistic }))(EditorPage)
